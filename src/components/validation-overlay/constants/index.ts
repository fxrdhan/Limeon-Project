...
export const STYLES = {
  overlay: 'fixed z-[1055] pointer-events-none',
  container:
  ...
  message: 'font-medium',
  arrow:
    'absolute -top-1 w-0 h-0 border-l-4 border-r-4 border-b-4 border-l-transparent border-r-transparent border-b-danger/75 backdrop-blur-xs',
};
