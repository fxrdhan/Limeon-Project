          ...
          >
            <div className="mt-2 min-h-[100px] max-h-[200px] p-0 px-0">
              <textarea
                ...
                className={classNames(
                  'text-sm w-full h-full min-h-[100px] max-h-[200px] p-2 pl-3 border border-slate-300 rounded-xl focus:outline-hidden focus:border-primary focus:ring-3 focus:ring-emerald-200 focus:ring-offset-0',
