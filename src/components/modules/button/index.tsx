...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants: Record<ButtonVariant, string> = {
      ...
      text: "bg-transparent hover:bg-opacity-10 outline-hidden ring-0 focus:shadow-none",
      danger:
    ...
    const baseClasses =
      "font-medium rounded-lg transition-all duration-300 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden focus:outline-hidden";
    return (
      <button
        ref={ref}
