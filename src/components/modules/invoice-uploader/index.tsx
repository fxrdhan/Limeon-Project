    ...
    <>
      ...
      >
        <div onClick={(e) => e.stopPropagation()}>
          <Card className="shadow-lg max-w-2xl mx-auto m-4">
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-black/50 text-white px-4 py-2 rounded-full flex items-center space-x-2">
