...
import { TbContainer, TbContainerOff } from 'react-icons/tb';
import {
...
export const DEFAULT_FILTER_OPERATORS = [
  ...
  },
  {
    ...
    icon: <FaEquals className="w-3 h-3" />,
  ...
  },
  {
    ...
    icon: <FaNotEqual className="w-3 h-3" />,
  ...
  },
  {
    ...
    icon: <FaGreaterThan className="w-3 h-3" />,
  ...
  },
  {
    ...
    icon: <FaLessThan className="w-3 h-3" />,
...
export const NUMBER_FILTER_OPERATORS = [
  ...
  },
  {
    ...
    icon: <FaGreaterThanEqual className="w-3 h-3" />,
  ...
  },
  {
    ...
    icon: <FaLessThanEqual className="w-3 h-3" />,
...
export const JOIN_OPERATORS = [
  {
    ...
    icon: <FaGreaterThan className="w-3 h-3 -rotate-90" />,
