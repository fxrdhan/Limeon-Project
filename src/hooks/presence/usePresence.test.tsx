...
describe("usePresence", () => {
  ...
  it("hydrates the navbar roster from browser-active presence state", async () => {
    ...
    expect(mockRealtimeService.replaceChannel).toHaveBeenCalledWith("browser-active", {
      config: {
        presence: {
          key: "user-a",
        },
  ...
  it("reconnects the roster channel after a channel error", async () => {
    ...
    expect(mockRealtimeService.replaceChannel).toHaveBeenLastCalledWith("browser-active", {
      config: {
        presence: {
          key: "user-a",
        },
