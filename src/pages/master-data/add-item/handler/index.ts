...
export function handleSelectChange({ originalHandleSelectChange, units, unitConversionHook }: any) {
    return (e: React.ChangeEvent<HTMLSelectElement>) => {
        const { name, value } = e.target;
        originalHandleSelectChange(e);
        if (name === "unit_id" && value) {
            const selectedUnit = units.find((unit: any) => unit.id === value);
            if (selectedUnit) {
...
export function handleDropdownChange(handleSelectChange: (e: React.ChangeEvent<HTMLSelectElement>) => void) {
...
export function handleMarginChange({ setMarginPercentage, formData, calculateSellPriceFromMargin, updateFormData }: any) {
...
export function handleSellPriceChange({ handleChange, calculateProfitPercentage, setMarginPercentage }: any) {
    return (e: React.ChangeEvent<HTMLInputElement>) => {
        handleChange(e);
        setTimeout(() => {
...
export function startEditingMargin({ calculateProfitPercentage, setMarginPercentage, setEditingMargin, marginInputRef }: any) {
    return () => {
...
export function stopEditingMargin({ setEditingMargin, marginPercentage, formData, calculateSellPriceFromMargin, updateFormData }: any) {
    return () => {
...
export function startEditingMinStock({ formData, setMinStockValue, setEditingMinStock, minStockInputRef }: any) {
    return () => {
...
export function stopEditingMinStock({ setEditingMinStock, minStockValue, updateFormData, formData, setMinStockValue }: any) {
    return () => {
