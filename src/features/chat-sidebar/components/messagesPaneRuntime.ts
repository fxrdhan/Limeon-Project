...
export interface MessageItemRuntime {
  interaction: {
    ...
    isInitialOpenPinPending: ChatSidebarRuntimeState["viewport"]["isInitialOpenPinPending"];
...
const buildMessageItemRuntime = (runtime: MessagesPaneRuntimeSource): MessageItemRuntime => ({
  ...
  menu: {
    ...
    dimmingMessageId: runtime.viewport.menuDimmingMessageId,
  ...
  content: {
    ...
    focusReplyTargetMessage: runtime.viewport.focusReplyTargetMessage,
  },
  actions: {
