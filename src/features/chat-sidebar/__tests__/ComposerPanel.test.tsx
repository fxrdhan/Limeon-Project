...
const buildComposerRuntime = (): ComposerRuntime => ({
  composer: {
    message:
    ...
    editingMessageAuthorLabel: null,
    isEditingMessageFromCurrentUser: false,
    replyingMessagePreview: null,
    replyingMessageAuthorLabel: null,
    isReplyingMessageFromCurrentUser: false,
  ...
  previews: {
    ...
    isAttachmentMenuRepositionPaused: false,
    setIsAttachmentMenuRepositionPaused: vi.fn(),
