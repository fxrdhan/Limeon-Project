...
type ChatSidebarRuntime = ReturnType<typeof useChatSidebarRuntimeState>;
type ChatSidebarRefs = ReturnType<typeof useChatSidebarRefs>;

export const buildChatHeaderModel = (runtime: ChatSidebarRuntime) => ({
...
export const buildComposerPanelModel = (
  ...
  actions: {
    ...
    onCloseImageActionsMenu: runtime.previews.closeImageActionsMenu,
