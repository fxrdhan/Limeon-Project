...
import {
  ...
  fetchLowStockItems,
  fetchMonthlyRevenueComparison,
  fetchRecentTransactions,
  fetchSalesAnalytics,
  fetchTopSellingMedicines,
} from '../infrastructure/dashboardData';
...
export const useSalesAnalytics = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await fetchSalesAnalytics(days);
      if (result.error) throw result.error;
      return result.data;
    },
    enabled: options?.enabled ?? true,
...
export const useMonthlyRevenueComparison = (options?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await fetchMonthlyRevenueComparison();
      if (result.error) throw result.error;
      return result.data;
    },
    enabled: options?.enabled ?? true,
