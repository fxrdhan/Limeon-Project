...
export function RandomItemFloatingButton({
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-400 disabled:cursor-not-allowed text-white rounded-full p-4 shadow-lg transition-all duration-200 hover:scale-105 z-50"
