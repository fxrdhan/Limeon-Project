...
export const normalizeChatDirectoryUser = (
  ...
  return {
    ...
    last_message: getOptionalString(user.last_message, "directory_user.last_message"),
    last_message_created_at: getOptionalString(
      user.last_message_created_at,
      "directory_user.last_message_created_at",
    ),
  };
};
